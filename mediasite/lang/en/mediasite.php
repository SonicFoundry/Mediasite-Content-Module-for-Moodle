...
$string['assignment_submission_not_enabled'] = 'Assignment Submission require an additional plugin to be installed. Please install the Atto Mediasite editor plugin.';
